...
public class AppConstant {
   ...
   public static String[][] mTeamArrayList = {
        ...
        public static int[][][] mMatchArrayList = {
                ...
                {
                        {13 , 1 , 2 },{13, 6, 0},{13, 3, 4}, {13, 10 , 8 },{13, 9, 7}
                },
                {
                        {14 , 6 , 3  },{14, 4, 2},{14, 9, 1}, {14, 7 , 8 },{14, 10, 0}
                },
                {
                        {15 , 4 , 1},{15, 0, 7 },{15, 3, 10}, {15, 2 , 6 },{15, 8, 9 }
                },
                {
                        {16 , 7 , 3 },{16, 6, 4 },{16, 10, 2}, {16, 8 , 1 },{16, 9, 0 }
                },
                {
                        {17 , 1 , 6},{17, 4, 10 },{17, 0, 8}, {17, 2 , 7},{ 17, 3, 9 }
                },
                {
                        { 18 , 11 , 11 }  , { 18, 11, 11 }
                },
